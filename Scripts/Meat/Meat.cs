...
[System.Serializable]  // System.Serializable 컴포넌트에 노출되게끔
public class Meats
{
...
public class Meat : MonoBehaviour
{
    ...
    //{
    //    GrillingMeat_AppManager.RoundStart += RoundStart;
    //    GrillingMeat_Timer.RoundEnd += RoundEnd;
    //}
    ...
    //    // 카운트 다운
    //    yield return new WaitUntil(() => GrillingMeat_Timer.isPlaying);

    //    while (GrillingMeat_Timer.Instance.timeLeft > 0f)
    //    {
    //        //// 랜덤 1, 2 
    //        //UpCount = Random.Range(minSecondbetweenCubes, maxSecondbetweenCubes);
    //        //// 0.7 ~0.9초
    //        //DownCount = 0.5f + (Random.Range(minSecondbetweenCubes, maxSecondbetweenCubes) * 0.2f);
    //        ////Debug.Log("시작 DownCount : " + DownCount);
    ...
    //        //// 1.6초 ~ 1.9초
    //        //yield return new WaitForSecondsRealtime(2f + (UpCount * 0.3f));

    //        // # 랜덤고기 Prefabs 처리
    //        // for 문으로 고기있는지 없는지 확인 후 
    //        // 없는 곳에 랜덤고기 부모오브젝트 아래 생성
    //        //Debug.Log("고기없는지 확인");
