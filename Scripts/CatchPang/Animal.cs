...
public class Animal : MonoBehaviour
{
    ...
    private IEnumerator Run()
    {
        ...
        navMeshAgent.SetDestination(CatchPang_DataManager.Instance.transform.position);
    ...
    {
        if (collision.gameObject.CompareTag("Ball")/*== LayerMask.NameToLayer("Balls")*/)
        {
            // 맞을 때 소리
    ...
    {
        return Vector3.Distance(this.transform.position, CatchPang_DataManager.Instance.transform.position);
    }
